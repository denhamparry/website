...
generator (v0.87.0) using the PaperMod theme. The site is deployed on Netlify at
...
```bash
make hugo_serve         # Start Hugo dev server at http://localhost:1313
...
- **Dockerfile**: Development container setup (Ubuntu 18.04 + Hugo 0.87.0 + Ruby
  gems)
